...
<script src="/static/front/js/questionUpdate.js"></script>
   <div id="qnasection">
    <h2>질문지 작성</h2>
    <form action="questionUpdateOk" method="post">
    ...
    <input type="hidden" value="${qdto.ctno}" id="ctno">
       <table align="center">
    	...
    	<tr>
			...
			<td>
			  <input type="text" class="form-control" id="usr" name="title" value="${qdto.title}">
			</td>
		</tr>
		<tr>
		<td>
  		...
  		<td>
  			<textarea class="form-control" rows="5" id="summernote" name="content">${qdto.content}</textarea>
  		</td>
		</tr>
		<tr>
			<td colspan="2" align="center">
				<label><input type="checkbox" id="type1">게시글 노출</label>
					<input type="hidden" name="type" id="type" value="${qdto.type}">
			</td>
		</tr>
		 <tr>
		 	<td colspan="2" align="center">
