...
<strong class="th">작성일</strong> <span class="td"><fmt:formatDate value="${writedate}" pattern="yyyy-MM-dd"/></span>
</li>
<li class="hit ">
<strong class="th">조회수</strong> <span class="td">${dto.read_cnt}</span>
</li>
</ul>
</td>
</tr>
...
<tbody><tr>
<td align="right">
<a href="/shop/notice"><span class="bhs_button yb" style="float:none;">목록</span></a>
<a href="/shop/notice_update?no=${dto.nno}"><span class="bhs_button yb" style="float:none;">수정</span></a>
<a href="/shop/notice_delete?no=${dto.nno}" id="delete"><span class="bhs_button yb" style="float:none;">삭제</span></a>
</td>
</tr>
</tbody></table>
</td>
...
<ul>
<li class="prev ">
<strong>이전글</strong><a href="/board/free/read.html?no=27121&amp;board_no=1&amp;page="></a>
<a href="/notice_view?no=${dto.nno-1}">${dto1.prev}</a>
</li>
<li class="prev ">
<strong>다음글</strong><a href="/board/free/read.html?no=27121&amp;board_no=1&amp;page="></a>
<a href="/notice_view?no=${dto.nno+1}">${dto1.next}</a>
</li>
<br>
