...
<tbody><tr>
<td align="right">
<a href="/admin/notice"><span class="bhs_button yb" style="float:none;">목록</span></a>
<a href="/admin/notice_update?no=${dto.nno}"><span class="bhs_button yb" style="float:none;">수정</span></a>
<a href="/admin/notice_delete?no=${dto.nno}" id="delete"><span class="bhs_button yb" style="float:none;">삭제</span></a>
</td>
</tr>
</tbody></table>
